...
import {BehaviorSubject, filter, map, pairwise, tap, throttleTime} from 'rxjs';
...
export class AssignmentsComponent implements OnInit, AfterViewInit {
  ...
  rendu:boolean|null = null;

  rendu$ = new BehaviorSubject<boolean|null>(null);
  ...
  showAll() {
    this.rendu$.next(null);
    this.premierePage();
  }

  showRendu() {
    this.rendu$.next(true);
    this.premierePage();
  }

  showNonRendu() {
    this.rendu$.next(false);
    this.premierePage();
  }
}
