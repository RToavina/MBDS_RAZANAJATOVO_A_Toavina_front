...
import matieresData from '../../assets/matieres.json';
...
export class AssignmentsService {
  ...
  getAssignments(page: number, limit: number, rendu?: boolean|null): Observable<any> {
  ...
  peuplerBDAvecForkJoin(): Observable<any> {
    ...
    const myArray = ['Technologies Web', 'Base de données', 'Grails'];
    ...
    bdInitialAssignments.forEach((a) => {
      ...
      nouvelAssignment.matiere = myArray[rand];
